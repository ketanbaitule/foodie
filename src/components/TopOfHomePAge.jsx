      ...
      <div className="flex flex-col  gap-16 justify-center items-start">
        ...
        <div className="rounded-full w-full xl:w-[750px] xl:h-[750px] justify-center items-center">
          ...
          />
            ...
            src="/mint-leaf3.png"
            alt=" food image"
            className="relattive translate-x-12  translate-y-10 sm:translate-x-28  xl:translate-y-16 xl:translate-x-28 skew-x-12 -rotate-45 w-32 h-28 sm:w-[300px] sm:h-[280px]"
          />
                </div>
              <img
            src="/home.jpeg"
            alt=" food image"
            className="w-[300px] h-[300px] sm:w-[460px] sm:h-[460px] xl:w-[550px] xl:h-[550px] rounded-full absolute "
          />
              </div>
            </div>
          </div>
